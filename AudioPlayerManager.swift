...
@objc(AudioPlayerManger)
class AudioPlayerManger: NSObject, AVAudioPlayerDelegate, RCTBridgeModule {

  let (AudioPlayerEventProgress, AudioPlayerEventFinished, AudioPlayerError) = ("playerProgress", "playerFinished","playerError")
